      ...
      <>
        ...
        <div className="rightbarInfo">
          <div className="rightbarInfoItem">
            ...
            <span className="rightbarInfoValue">Programación</span>
          </div>
          <div className="rightbarInfoItem">
            <span className="rightbarInfoKey">Semestre:</span>
            <span className="rightbarInfoValue">Quinto</span>
          </div>
          <div className="rightbarInfoItem">
            <span className="rightbarInfoKey">Encargado:</span>
            <span className="rightbarInfoValue">Juan de Dios Bátiz</span>
          </div>
        </div>
